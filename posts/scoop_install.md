...
如果你想选择安装到自定义目录，请见<a href = "#01">自定义目录安装步骤</a> 。
...
你创建的 Scoop 文件夹在 `C:\Users\你的用户名` 处。关于如何用 Scoop 安装软件，可见 <a href="post.html?file=posts/scoop_install_software.md" target="_blank">如何使用Scoop安装软件</a>

---

<h2 id = "01">自定义目录安装步骤</h2>
